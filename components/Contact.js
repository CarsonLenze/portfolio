          ...
          <div className="md:ml-4">
            <header className="">
              ...
              <p className="font-light text-base text-gray-200 mt-2">
                Fill in the details and I&lsquo;ll get back to you as soon as I can.
              </p>
            </header>
            <div className="icons-container inline-flex flex-col my-20">
              <div className="flex flex-row space-x-6 rounded-md border2 border-[#02044A] hover:border hover:border-blue-500 p-3">
                <svg
                ...
                <p className="text-gray-50 font-light text-sm marbottom">
                  {"(317) 349-8805"}
                </p>
              </div>
              <div className="flex flex-row space-x-6 rounded-md border2 border-[#02044A] hover:border hover:border-blue-500 p-3">
            ...
            <div className="social-icons flex flex-row space-x-8">
              <a
                ...
                className="h-10 w-10 rounded-full flex items-center justify-center cursor-pointer nounder"
              >
                <i
                  className={`fab fa-instagram fa-3x socialicons contactitems`}
                />
              </a>
              <a
              ...
              >
                <i
                  className={`fab fa-discord fa-3x socialicons contactitems`}
                />
              </a>
              <a
              ...
              >
                <i
                  className={`fab fa-twitter fa-3x socialicons contactitems`}
                />
              </a>
            </div>
          </div>
