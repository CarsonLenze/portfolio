export function Contact() {
    return (
        <section id="contact">
          ...
          <div className="relative z-10 rounded-md shadow-md bg-[#02044A] pad md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:ml-4">
                ...
                <div className="icons-container inline-flex flex-col my-20">
                  <div className="flex flex-row space-x-6 rounded-md border2 border-[#02044A] hover:border hover:border-blue-500 pad2">
                    <svg
                    ...
                    <p className="text-gray-50 font-light text-sm pad3">
                      {'(317) 349-8805'}
                    </p>
                  </div>
                  <div className="flex flex-row space-x-6 rounded-md border2 border-[#02044A] hover:border hover:border-blue-500 pad2">
              ...
              <form className="form rounded-lg bg-white pad2 flex flex-col">
